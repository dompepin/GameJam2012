...
- (void)draw {
    ...
    CGRect snakeBoundingBox = CGRectMake(_snakeHead.boundingBox.origin.x, _snakeHead.boundingBox.origin.y, _snakeHead.boundingBox.size.width - 10, _snakeHead.boundingBox.size.height - 10);
